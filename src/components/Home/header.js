      ...
      <div className="max-w-7xl mx-auto px-8 mt-28 mb-32 md:mt-36 md:mb-60">
        <Fade>
          <div className="flex justify-center flex-col text-center gap-6 md:mx-28 lg:mx-44">
            ...
            <h2 className="text-white font-poppins opacity-80 font-normal tracking-wide text-base xxs:text-base xs:text-lg sm:text-lg md:text-lg lg:text-2xl 2xl:text-2xl mx-4 sm:mx-10 md:mx-20 lg:mx-28 xl:mx-36">
