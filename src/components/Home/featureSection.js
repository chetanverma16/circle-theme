          ...
          <div className="mt-12 mb-32 px-0 mx-0 grid grid-cols-1 xxs:grid-cols-1 xs:grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div className="bg-lightblack p-8 rounded-xl service-card ">
              <div className="flex items-center justify-start mb-2">
                ...
                <h1 className="text-white text-2xl sm:text-xl md:text-2xl align-middle">
          ...
          <div className="mt-10 mb-32 px-0 mx-0 grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="p-8 service-card">
              ...
              <p className="mt-5 text-white opacity-50 text-lg">
                ...
                needs. We listen, we personalize, we deliver IT solutions that
                are as individual as your business.
              </p>
            </div>
            <div className="p-8 service-card">
              ...
              <p className="mt-5 text-white opacity-50 text-lg">
                ...
                skilled; they're passionate professionals who thrive on
