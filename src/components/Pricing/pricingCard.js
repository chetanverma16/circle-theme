...
const PricingCard = ({ plan, isYearlyBilling }) => {
  ...
  const customHandle = (props) => {
    ...
    // Customize your handle here. This is a basic example.
    return (
      <div {...restProps} style={{ ...restProps.style, backgroundColor: 'blue', display: 'inline-block', cursor: 'pointer' }}>
    ...
    <Fade bottom>
      <div
        ...
        <div className="relative z-10">
          ...
          {plan.slider && (<Slider min={start} max={max} defaultValue={start} onChange={handleSliderChange} handle={customHandle} className="mt-6" />)}
